            ...
            {data.map((item, index) => {
                return(
                   <TouchableOpacity onPress={()=>navigation.navigate('Screen3')} key={index} style={styles.Imagee}>
                    ...
                    <View style={{flexDirection:'row',justifyContent:'flex-start',height:20,width:'90%'}}>
                    <Text style={{fontSize:12,color:'gray'}}>{item.address}</Text>
                    <TouchableOpacity style={{borderRadius:25,backgroundColor:'red',width:'20%',height:20,justifyContent:"center",alignItems:"center", marginLeft:100}}>
